...
public class ImageWindow extends JFrame {
	...
	private Image cannyEdgedImage = null;
	private Image edgedImage = null;
	private Image shapedImage = null;
	...
	public ImageWindow() {
		...
		MenuItem viewShapes = new MenuItem();
		viewShapes.setLabel("View Shapes");
		viewShapes.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				shapedImage = originalImage.clone();
				shapedImage.findShapes(edgeThresholdFactor);
				prepareToDisplay(shapedImage);
				repaint();
			}});
		
		MenuItem viewCannyEdges = new MenuItem();
		viewCannyEdges.setLabel("View Canny Edges");
		viewCannyEdges.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				cannyEdgedImage = originalImage.clone();
				cannyEdgedImage.findCannyEdges(edgeThresholdFactor);
				prepareToDisplay(cannyEdgedImage);
				repaint();
			}});
		...
		viewMenu.add(viewCannyEdges);
		viewMenu.add(viewShapes);
